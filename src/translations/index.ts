export const translations = {
  en: {
    ...
    header: {
      ...
      nav: {
        home: 'Home',
        about: 'About Panchayat Samiti',
        employees: 'Employees Gallery',
        schemes: 'Schemes Gallery',
        talents: 'Talents Gallery',
        map: 'Map',
        contact: 'Contact Us',
      },
    },
    ...
    quickLinks: {
      ...
      employees: {
        title: 'Our Team',
        description: 'Meet the dedicated employees serving you',
      },
      talents: {
        title: 'Local Talents',
    ...
    contact: {
      ...
      form: {
        ...
        message: 'Message',
        submit: 'Send Message',
        required: '* Required fields. Your information will be kept confidential.',
    ...
    footer: {
      ...
      copyright: 'Copyright @2025 PSPARSEONI | Design & Development by',
  ...
  mr: {
    ...
    quickLinks: {
      ...
      employees: {
        title: 'आमचा संघ',
        description: 'तुमची सेवा करणाऱ्या समर्पित कर्मचाऱ्यांना भेटा',
      },
      talents: {
    ...
    map: {
      ...
      hours: {
        ...
        weekdayTime: 'सकाळी 10:00 - संध्याकाळी 5:00',
        saturday: 'शनिवार:',
        saturdayTime: 'सकाळी 10:00 - दुपारी 2:00',
        sunday: 'रविवार:',
        sundayStatus: 'बंद',
        lunchBreak: '*जेवणाचा ब्रेक: दुपारी 1:00 - 2:00',
      },
      contact: {
        office: 'कार्यालय:',
        helpline: 'हेल्पलाइन:',
    ...
    contact: {
      badge: 'संपर्कात रहा',
      title: 'संपर्क करा',
      description: 'प्रश्न आहेत किंवा मदत हवी आहे? आम्ही मदत करण्यासाठी येथे आहोत. खालील कोणत्याही माध्यमातून आमच्याशी संपर्क साधा.',
      emailTitle: 'ईमेल पत्ता',
      phoneTitle: 'संपर्क क्रमांक',
      addressTitle: 'कार्यालय पत्ता',
      formTitle: 'आम्हाला संदेश पाठवा',
      successTitle: 'संदेश यशस्वीरित्या पाठवला!',
      successMessage: 'आमच्याशी संपर्क साधल्याबद्दल धन्यवाद. आम्ही लवकरच तुमच्याशी संपर्क करू.',
      form: {
        name: 'पूर्ण नाव',
        email: 'ईमेल पत्ता',
        phone: 'फोन नंबर',
        ...
        message: 'संदेश',
        submit: 'संदेश पाठवा',
        required: '* आवश्यक फील्ड. आपली माहिती गोपनीय ठेवली जाईल.',
    ...
    footer: {
      ...
      links: {
        ...
        contact: 'संपर्क करा',
        rti: 'आरटीआय माहिती',
        grievance: 'सार्वजनिक तक्रार',
        tenders: 'निविदा आणि सूचना',
        downloads: 'डाउनलोड',
        privacy: 'गोपनीयता धोरण',
        terms: 'सेवा अटी',
        sitemap: 'साइट नकाशा',
      },
      copyright: 'प्रताधिकार @2025 PSPARSEONI | डिझाइन आणि विकास',
